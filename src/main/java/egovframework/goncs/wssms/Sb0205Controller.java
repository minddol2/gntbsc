...
public class Sb0205Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05.do")
    public String get_sb02_sub05(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_05";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_view.do")
    public String view_sb02_sub05(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_05_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_write.do")
    public String write_sb02_sub05(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_05_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_Add.do")
    public String add_sb02_sub05(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub05_write.do";
    	}
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_delete.do")
    public String delete_sb02_sub05(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_modify.do")
    public String modi_sb02_sub05(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_05_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub05_Updt.do")
    public String updt_sb02_sub05(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub05_modify.do";
    	}
