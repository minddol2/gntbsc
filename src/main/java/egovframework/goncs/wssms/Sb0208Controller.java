...
public class Sb0208Controller {
    ...
    @RequestMapping("/sb02/sub02_08.do")
    public String get_sb02_sub0208(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_view.do")
    public String view_sb02_sub0208(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_write.do")
    public String write_sb02_sub0208(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_Add.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_delete.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_modify.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_08_Updt.do")
