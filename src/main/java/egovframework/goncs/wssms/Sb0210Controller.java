...
public class Sb0210Controller {
    ...
    @RequestMapping("/sb02/sub02_10.do")
    public String get_sb02_sub0210(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	boardVO.setBbsId("BBSMSTR_000000000311");
    	...
    	return "egovframework/gntbsc/wssms/sub02_10";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_view.do")
    public String view_sb02_sub0210(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_10_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_write.do")
    public String write_sb02_sub0210(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_10_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_Add.do")
    public String add_sb02_sub0210(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_10_write.do";
    	}
    	...
    	//status.setComplete();
    	return "redirect:/sb02/sub02_10.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_delete.do")
    public String delete_sb02_sub0210(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_modify.do")
    public String modi_sb02_sub0210(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_10_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_10_Updt.do")
    public String updt_sb02_sub0210(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_10_modify.do";
    	}
