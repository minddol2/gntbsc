...
public class Sb0207Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07.do")
    public String get_sb02_sub07(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	boardVO.setBbsId("BBSMSTR_000000000308");
    	...
    	return "egovframework/gntbsc/wssms/sub02_07";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_view.do")
    public String view_sb02_sub07(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_07_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_write.do")
    public String write_sb02_sub07(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_07_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_Add.do")
    public String add_sb02_sub07(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub07_write.do";
    	}
    	...
    	if (isAuthenticated) {
    		...
    		if(board.getCategory() == null || board.getCategory().equals("")) {
    			board.setCategory("off");
    		}
    		...
    		String link_url = board.getLink_url();
    		if( (!link_url.equals("")) && (link_url.indexOf("http") <= -1) ) {
    			link_url = "http://" + link_url;
    		} 
    		board.setLink_url(link_url);
	    
    		bbsMngService.insertBoardArticle(board);
    	}

    	//status.setComplete();
    	return "redirect:/sb02/sub07.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_delete.do")
    public String delete_sb02_sub07(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_modify.do")
    public String modi_sb02_sub07(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_07_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub07_Updt.do")
    public String updt_sb02_sub07(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub07_modify.do";
    	}
