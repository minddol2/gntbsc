...
@Controller
public class Sub0203Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03.do")
    public String get_sb02_sub03(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	boardVO.setBbsId("BBSMSTR_000000000302");
    	...
    	return "egovframework/gntbsc/wssms/sub02_03";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_view.do")
    public String view_sb02_sub03(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_03_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_write.do")
    public String write_sb02_sub03(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_03_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_Add.do")
    public String add_sb02_sub03(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub03_write.do";
    	}
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_delete.do")
    public String delete_sb02_sub03(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_modify.do")
    public String modi_sb02_sub03(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_03_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub03_Updt.do")
    public String updt_sb02_sub03(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub03_modify.do";
    	}
