...
public class Sb0202Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02.do")
    public String get_sb02_sub02(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_02";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_view.do")
    public String view_sb02_sub02(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_02_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_write.do")
    public String write_sb02_sub02(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_02_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_Add.do")
    public String add_sb02_sub02(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_write.do";
    	}
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_delete.do")
    public String delete_sb02_sub02(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_modify.do")
    public String modi_sb02_sub02(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_02_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_Updt.do")
    public String updt_sb02_sub02(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_modify.do";
    	}
