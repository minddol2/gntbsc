...
public class Sb0206Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06.do")
    public String get_sb02_sub06(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_06";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_view.do")
    public String view_sb02_sub06(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_06_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_write.do")
    public String write_sb02_sub06(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_06_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_Add.do")
    public String add_sb02_sub06(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub06_write.do";
    	}
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_delete.do")
    public String delete_sb02_sub06(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_modify.do")
    public String modi_sb02_sub06(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_06_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub06_Updt.do")
    public String updt_sb02_sub06(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub06_modify.do";
    	}
