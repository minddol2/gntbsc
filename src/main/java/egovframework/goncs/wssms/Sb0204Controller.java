...
public class Sb0204Controller {
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04.do")
    public String get_sb02_sub04(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_04";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_view.do")
    public String view_sb02_sub04(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_04_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_write.do")
    public String write_sb02_sub04(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_04_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_Add.do")
    public String add_sb02_sub04(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub04_write.do";
    	}
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_delete.do")
    public String delete_sb02_sub04(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_modify.do")
    public String modi_sb02_sub04(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_04_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub04_Updt.do")
    public String updt_sb02_sub04(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub04_modify.do";
    	}
