...
public class Sb0209Controller {
    ...
    @RequestMapping("/sb02/sub02_09.do")
    public String get_sb02_sub0209(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_09";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_view.do")
    public String view_sb02_sub0209(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_09_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_write.do")
    public String write_sb02_sub0209(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_09_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_Add.do")
    public String add_sb02_sub0209(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_09_write.do";
    	}
    	...
    	//status.setComplete();
    	return "redirect:/sb02/sub02_09.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_delete.do")
    public String delete_sb02_sub0209(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_modify.do")
    public String modi_sb02_sub0209(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/wssms/sub02_09_modi";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sb02/sub02_09_Updt.do")
    public String updt_sb02_sub0209(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sb02/sub02_09_modify.do";
    	}
