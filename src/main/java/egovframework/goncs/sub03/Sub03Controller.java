...
public class Sub03Controller {
	...
	@RequestMapping(value = "/sub03/sub01_01.do")
	public String get_sub03_page_01(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model, Locale locale) throws Exception{
	...
	@RequestMapping(value = "/sub03/sub01_01v.do")
	public String get_sub03_page_01v(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
