...
public class BBSManageDAO extends EgovComAbstractDAO {
    ...
    public List<BoardVO> selectBoardArticleList_qna(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardArticleList_qna", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardArticleList_Faq(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardArticleList_Faq", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardNoticeList(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardNoticeList", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardNoticeList2(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardNoticeList2", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardNoticeList3(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardNoticeList3", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardCompList(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardCompList", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardCompList2(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardCompList2", boardVO);
    }
    
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectBoardArticleListCenter(BoardVO boardVO) throws Exception {
    	return (List<BoardVO>) list("BBSManageDAO.selectBoardArticleListCenter", boardVO);
    }
