...
public class Board implements Serializable {
	...
	public String leftx = "0";
	public String lefty = "0";
	public String ssWords = "";
	...
	public String getSsWords() {
		return ssWords;
	}

	public void setSsWords(String ssWords) {
		this.ssWords = ssWords;
	}
	...
	public String getNttAd() {
		return nttAd;
	}

	public void setNttAd(String nttAd) {
		this.nttAd = nttAd;
	}
