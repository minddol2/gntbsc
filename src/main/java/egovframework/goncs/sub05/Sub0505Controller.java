...
@Controller
public class Sub0505Controller {
    ...
    @RequestMapping("/sub05/sub05_01.do")
	public String get_sub05_page_05(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "egovframework/gntbsc/sub05/sub05_01";
	}
	
    @RequestMapping("/sub05/sub05_01_view.do")
	public String get_sub05_page_05v(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
		...
		return "egovframework/gntbsc/sub05/sub05_01_view";
	}
}
