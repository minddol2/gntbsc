...
@Controller
public class Sub0501Controller {
    ...
    @RequestMapping("/sub05/sub01_01.do")
    public String get_sub05_sub0101(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub01_01";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_view.do")
    public String view_sub05_sub0101(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub01_01_view";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_write.do")
    public String write_sub05_sub0101(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub01_01_write";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_Add.do")
    public String add_sub05_sub0101(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect:/sub05/sub01_write.do";
    	}
    	...
    	//status.setComplete();
    	return "redirect://sub05/sub01_01.do";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_delete.do")
    public String delete_sub05_sub0101(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") Board board,
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_modify.do")
    public String modi_sub05_sub0101(@ModelAttribute("searchVO") BoardVO boardVO, @ModelAttribute("board") BoardVO vo, 
    		ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub01_01_modify";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub01_Updt.do")
    public String updt_sub05_sub0101(final MultipartHttpServletRequest multiRequest, @ModelAttribute("searchVO") BoardVO boardVO,
    	...
    	if (bindingResult.hasErrors()) {
    		...
    		return "redirect://sub05/sub01_modify.do";
    	}
