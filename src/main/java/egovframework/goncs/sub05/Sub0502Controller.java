...
@Controller
public class Sub0502Controller {
    ...
    @RequestMapping("/sub05/sub02_01.do")
    public String get_sub05_sub0201(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub02_01";
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/sub05/sub02_view.do")
    public String view_sub05_sub0201(@ModelAttribute("searchVO") BoardVO boardVO, ModelMap model) throws Exception {
    	...
    	return "egovframework/gntbsc/sub05/sub02_01_view";
    }
}
