...
function fn_egov_regist_BBS() {
    ...
    if (confirm('저장하시겠습니까?')) {
        ...
        document.board.action = "<c:url value='/sb02/sub02_08_Updt.do'/>";
...
<input type="hidden" name="returnUrl" value="<c:url value='/sb02/sub02_08_modify.do'/>"/>
	...
	<div class="writecom writeTop">
		<ul>
			...
			<li><span class="w_txt">제목</span> <span class="inputTxt">
				<input type="text" name="nttSj" class="input_txt w-col01" style="ime-mode: active;" id="nttSj" hname="제목" value="<c:out value="${result.nttSj}" />"  title="제목 입력" /></span>
			</li>
			<li><span class="w_txt">키워드</span> <span class="inputTxt"><input 	type="text" name="ssWords" class="input_txt w-col01"
						style="ime-mode: active;" id="ssWords" hname="키워드" value="<c:out value="${result.ssWords}" />" option=""	required="required" title="키워드 입력" /></span></li>
			<li><span class="w_txt">대표자</span> <span class="inputTxt"><input 	type="text" name="ceoName" class="input_txt w-col01" style="width:150px"
						style="ime-mode: active;" id="ceoName" hname="대표자" value="<c:out value="${result.ceoName}" />" option=""	required="required" title="대표자 입력" /></span></li>
			<li><span class="w_txt">연락처</span> <span class="inputTxt"><input 	type="text" name="telnum" class="input_txt w-col01" style="width:150px"
						style="ime-mode: active;" id="telnum" hname="연락처" value="<c:out value="${result.telnum}" />" option=""	required="required" title="연락처 입력" /></span></li>
			<li><span class="w_txt">이메일</span> <span class="inputTxt"><input 	type="text" name="email" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="email" hname="이메일" value="<c:out value="${result.email}" />" option=""	required="required" title="이메일 입력" /></span></li>
			<li><span class="w_txt">홈페이지</span> <span class="inputTxt"><input 	type="text" name="homepage" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="homepage" hname="홈페이지" value="<c:out value="${result.homepage}" />" option=""	required="required" title="홈페이지 입력" /></span></li>
			<li><span class="w_txt">SNS</span> <span class="inputTxt"><input 	type="text" name="snslink" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="snslink" hname="SNS" value="<c:out value="${result.snslink}" />" option=""	required="required" title="SNS 입력" /></span></li>
			<li><span class="w_txt">작성자</span> <span class="inputTxt"><input
						type="text" name="ntcrNm" class="input_txt" style="ime-mode: active;" id="ntcrNm" hname="작성자" value="<c:out value='${user.us_name}'/>" title="작성자 입력" /></span></li>
			
			
			</ul>
	</div>
	<div class="writeCon">
		<textarea id="nttCn" name="nttCn" title="본문내용" style="width:98%; min-width:300px; height:250px; display:none;"><c:out value="${result.nttCn}" escapeXml="false" /></textarea>
<script type="text/javascript">
var oEditors = [];
...
nhn.husky.EZCreator.createInIFrame({
	...
	<div class="writeCon">
		<textarea id="nttAd" name="nttAd" title="본문내용" style="width:98%; min-width:300px; height:250px; display:none;"><c:out value="${result.nttAd}" escapeXml="false" /></textarea>
<script type="text/javascript">
var oEditors2 = [];
...
nhn.husky.EZCreator.createInIFrame({
	...
	<div class="writecom writeBottom">
		...
		<ul>
			<li><span class="w_txt">첨부파일</span><span class="inputTxt"><input type="file" name="file_6" id="egovComFileUploader" 
				class="input_txt" hname="첨부파일" title="첨부파일을 찾아 선택하세요" /></span></li>
		</ul>
	</div>
	</c:if>
