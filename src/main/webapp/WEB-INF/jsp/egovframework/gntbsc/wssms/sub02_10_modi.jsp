...
function fn_egov_regist_BBS() {
    ...
    if (confirm('저장하시겠습니까?')) {
        ...
        document.board.action = "<c:url value='/sb02/sub02_10_Updt.do'/>";
        document.board.submit();
    }
}

function fn_egov_select_BBSList() {
    document.board.action = "<c:url value='/sb02/sub02_10.do'/>";
    document.board.submit();
} 
//-->
</script>
...
<input type="hidden" name="returnUrl" value="<c:url value='/sb02/sub02_10_modify.do'/>"/>
