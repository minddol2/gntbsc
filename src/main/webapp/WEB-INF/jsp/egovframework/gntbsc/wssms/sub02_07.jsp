...
function fn_egov_inqire_BBS(nttId, bbsId) {
	 ...
	 document.submitParam.action = "<c:url value='/sb02/sub07_view.do'/>";
...
<h4 class="tit_dot">팝업존 관리</h4>
	...
	<form name="frm" action="<c:url value='/sb02/sub07.do'/>"
		method="post">
	...
	<div class="basicList">
		<ul>
			...
			<li>
						...
						<span class="title">
							<form name="subForm" method="post" action="<c:url value='/sb02/sub07_view.do'/>">
	...
	<div class="boardButton">
		...
		<span><a href="<c:url value='/sb02/sub07_write.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>">글쓰기</a> </span> 
		</c:if>
	</div>
...
<form name="frm" action ="<c:url value='/sb02/sub07.do'/>" method="post">
