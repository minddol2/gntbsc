...
function fn_egov_select_List(pageNo) {
	...
	document.frm.action = "<c:url value='/sb04/sub02.do'/>";
	document.frm.submit();
}

function fn_egov_excel() {
	 document.excelfrm.action = "<c:url value='/sb04/sub02_excel.do'/>";
...
<form name="frm" action="<c:url value='/sb04/sub02.do'/>"  method="post" >
