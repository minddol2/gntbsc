...
function fn_egov_regist_BBS() {
    ...
    if (confirm('저장하시겠습니까?')) {
        ...
        document.board.action = "<c:url value='/sb02/sub01_Add.do'/>";
		...
		<div class="writecom writeTop">
			<ul>
				<li><span class="w_txt">제목</span> <span class="inputTxt">
					<input type="text" name="nttSj" class="input_txt w-col01" style="ime-mode: active;" id="nttSj" hname="제목" value="" option="" required="required" title="제목 입력" />
					</span></li>
				...
				<li><span class="w_txt">사이즈(가로)</span> <span class="inputTxt">
					<input type="text" name="sizex" class="input_txt" id="sizex" hname="사이즈(가로)" value="" title="사이즈(가로) 입력" />
					</span></li>
				<li><span class="w_txt">사이즈(세로)</span> <span class="inputTxt">
					<input type="text" name="sizey" class="input_txt" id="sizey" hname="사이즈(세로)" value="" title="사이즈(세로) 입력" />
					</span></li>
				<li><span class="w_txt">위치(X)</span> <span class="inputTxt">
					<input type="text" name="leftx" class="input_txt" id="leftx" hname="위치(X)" value="" title="위치(X) 입력" />
					</span></li>
				<li><span class="w_txt">위치(Y)</span> <span class="inputTxt">
					<input type="text" name="lefty" class="input_txt" id="lefty" hname="위치(Y)" value="" title="위치(Y) 입력" />
					</span></li>
				<li><span class="w_txt">이름</span> <span class="inputTxt">
					<input type="text" name="ntcrNm" class="input_txt" style="ime-mode: active;" id="ntcrNm" hname="이름" value="<c:out value='${user.us_name}'/>" option="" required="required" title="이름 입력" />
					</span></li>
			</ul>
		</div>
		<div class="writeCon">
