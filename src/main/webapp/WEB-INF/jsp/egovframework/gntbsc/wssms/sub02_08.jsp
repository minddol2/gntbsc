...
<script type="text/javascript">
	...
	function fn_egov_inqire_BBS(nttId, bbsId) {
		...
		document.submitParam.action = "<c:url value='/sb02/sub02_08_view.do'/>";
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<li>
				...
				<span class="title" style="width:50%;">
							<form name="subForm" method="post" action="<c:url value='/sb02/sub02_08_view.do'/>">
...
<div class="boardButton">
	...
	<c:if test="${us_level le 2}">
		<span><a href="<c:url value='/sb02/sub02_08_write.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>">글쓰기</a> </span>
	</c:if>
</div>
