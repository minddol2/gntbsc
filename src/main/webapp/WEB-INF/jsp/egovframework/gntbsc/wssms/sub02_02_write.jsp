...
function fn_egov_regist_BBS() {
    ...
    if (confirm('저장하시겠습니까?')) {
        ...
        document.board.action = "<c:url value='/sb02/sub02_Add.do'/>";
		...
		<div class="writecom writeTop">
			<ul>
				<li><span class="w_txt">공지</span> 
					<input type="radio" name="topx" id="topx" hname="공지" value="1" /><label for="topx">공지</label>
					<input type="radio" name="topx" id="topx2" hname="일반" value="0" checked /><label for="topx2">일반</label>
				</li>
				<li><span class="w_txt">상태</span> 
					<input type="radio" name="category" id="category1" hname="진행" value="1" /><label for="category1">진행</label>
					<input type="radio" name="category" id="category2" hname="마감" value="2" /><label for="category2">마감</label>
					<input type="radio" name="category" id="category3" hname="알림" value="3" checked /><label for="category3">알림</label>
				</li>
