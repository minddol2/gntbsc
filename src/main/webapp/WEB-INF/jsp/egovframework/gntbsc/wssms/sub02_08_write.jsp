		...
		<div class="writecom writeTop">
			<ul>
				...
				<li><span class="w_txt">키워드</span> <span class="inputTxt"><input 	type="text" name="ssWords" class="input_txt w-col01"
						style="ime-mode: active;" id="ssWords" hname="키워드" value="" option=""	required="required" title="키워드 입력" /></span></li>
				<li><span class="w_txt">대표자</span> <span class="inputTxt"><input 	type="text" name="ceoName" class="input_txt w-col01" style="width:150px"
						style="ime-mode: active;" id="ceoName" hname="대표자" value="" option=""	required="required" title="대표자 입력" /></span></li>
				<li><span class="w_txt">연락처</span> <span class="inputTxt"><input 	type="text" name="telnum" class="input_txt w-col01" style="width:150px"
						style="ime-mode: active;" id="telnum" hname="연락처" value="" option=""	required="required" title="연락처 입력" /></span></li>
				<li><span class="w_txt">이메일</span> <span class="inputTxt"><input 	type="text" name="email" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="email" hname="이메일" value="" option=""	required="required" title="이메일 입력" /></span></li>
				<li><span class="w_txt">홈페이지</span> <span class="inputTxt"><input 	type="text" name="homepage" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="homepage" hname="홈페이지" value="" option=""	required="required" title="홈페이지 입력" /></span></li>
				<li><span class="w_txt">SNS</span> <span class="inputTxt"><input 	type="text" name="snslink" class="input_txt w-col01" style="width:250px"
						style="ime-mode: active;" id="snslink" hname="SNS" value="" option=""	required="required" title="SNS 입력" /></span></li>
				<li><span class="w_txt">작성자</span> <span class="inputTxt"><input 	type="text" name="ntcrNm" class="input_txt"
						style="ime-mode: active;" id="ntcrNm" hname="이름" value="<c:out value='${user.us_name}'/>" option="" required="required" title="이름 입력" /></span></li>
			</ul>
		</div>
		<div class="writeCon">
			<textarea id="nttCn" name="nttCn" title="본문내용" style="width:98%; min-width:300px; height:250px; display:none;"></textarea>
<script type="text/javascript">
var oEditors = [];
...
nhn.husky.EZCreator.createInIFrame({
	...
	fCreator: "createSEditor2"
		...
		<div class="writeCon">
		<textarea id="nttAd" name="nttAn" title="본문내용" style="width:98%; min-width:300px; height:250px; display:none;"><c:out value="${result.nttAd}" escapeXml="false" /></textarea>
<script type="text/javascript">
var oEditors2 = [];
