...
<script type="text/javascript">
  ...
  function fn_egov_inqire_BBS(nttId, bbsId) {
    ...
    document.submitParam.action = "<c:url value='/sb02/sub02_08_view_test.do'/>";
    document.submitParam.submit();
  }

  function fn_egov_select_BBSList(pageNo) {
    document.frm.pageIndex.value = pageNo;
    document.frm.action = "<c:url value='/sb02/sub02_08_test.do'/>";
    document.frm.submit();
  }
  //-->
</script>
...
<form name="frm" action="<c:url value='/sb02/sub02_08_test.do'/>"
      method="post">
...
<div class="basicList">
  <ul>
    <li class="tit_li">
      ...
      <span class="title" style="width:55%;">제목</span>
      <span class="name">작성자</span>
      <span class="date">등록일</span>
      <span class="counter">조회</span>
    </li>
    <c:forEach var="result" items="${resultList}" varStatus="status">
      <li>
        ...
        <span class="title" style="width:50%;">
							<form name="subForm" method="post" action="<c:url value='/sb02/sub02_08_view_test.do'/>">
        ...
        <span class="counter"><c:out value="${result.inqireCo}"/></span>
      </li>
    </c:forEach>
...
<div class="boardButton">
  <span><a href="<c:url value='/sb02/sub02_08_test.do'/>">목록</a> </span>
  <c:if test="${us_level le 2}">
    <span><a href="<c:url value='/sb02/sub02_08_write_test.do'/>?bbsId=<c:out value="${boardVO.bbsId}"/>">글쓰기</a> </span>
  </c:if>
</div>
...
<form name="frm" action ="<c:url value='/sb02/sub02_08_test.do'/>" method="post">
