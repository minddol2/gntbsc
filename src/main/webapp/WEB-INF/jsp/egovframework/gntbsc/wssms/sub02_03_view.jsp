...
<script type="text/javascript">
	...
	function fn_egov_delete_BBS() {
        if (confirm('<spring:message code="common.delete.msg" />')) {
            document.frm.action = "<c:url value='/sb02/sub03_delete.do'/>";
            document.frm.submit();
        }   
    }
    
    function fn_egov_moveUpdt_BBS() {
        document.frm.action = "<c:url value='/sb02/sub03_modify.do'/>";
        document.frm.submit();          
    }
    
    function fn_egov_addReply_BBS() {
        document.frm.action = "<c:url value='/sb02/sub03_reply.do'/>";
        document.frm.submit();          
    } 
