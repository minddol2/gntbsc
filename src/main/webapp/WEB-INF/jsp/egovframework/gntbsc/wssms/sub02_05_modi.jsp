...
function fn_egov_regist_BBS() {
    ...
    if (confirm('저장하시겠습니까?')) {
        ...
        document.board.action = "<c:url value='/sb02/sub05_Updt.do'/>";
...
<input type="hidden" name="returnUrl" value="<c:url value='/sb02/sub05_modify.do'/>"/>
...
nhn.husky.EZCreator.createInIFrame({
	...
	<div class="writecom writeBottom">
		<ul>
			<li><span class="w_txt">썬네일</span><span class="inputTxt"><input type="file" name="file_1" id="egovComFileUploader" 
