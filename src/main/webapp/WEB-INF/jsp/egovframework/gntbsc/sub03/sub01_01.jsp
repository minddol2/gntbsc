...
<ul class="board_category">
	...
	<li><a href="javascript:egov_select_category('1');" <c:if test="${searchVO.category == '1'}">class="on"</c:if>>예비관광 스타트업</a></li>
	<li><a href="javascript:egov_select_category('2');" <c:if test="${searchVO.category == '2'}">class="on"</c:if>>지역혁신 관광 스타트업</a></li>
	<li><a href="javascript:egov_select_category('3');" <c:if test="${searchVO.category == '3'}">class="on"</c:if>>지역상생 관광벤처</a></li>
	<li><a href="javascript:egov_select_category('4');" <c:if test="${searchVO.category == '4'}">class="on"</c:if>>비상주 협력기업</a></li>
</ul>
