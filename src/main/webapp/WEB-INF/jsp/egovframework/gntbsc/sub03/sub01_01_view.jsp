...
<form name="frm" method="post" action="">
    ...
    <div class="com_introduce2">
        <div class="com_information">
            ...
            <div class="btn_down"><a href="javascript: void(0);"
                                     onclick="fn_egov_downFile_etc('${result.bbsId}','0','${result.atchFileId}')">회사소개서
                다운로드</a></div>
        </div>
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            ...
                            <c:forEach var="fileVO" items="${file_result}" varStatus="status">
                                <c:if test="${fileVO.fileSn gt 0 and (fileVO.fileExtsn == 'jpg' or fileVO.fileExtsn == 'png' or fileVO.fileExtsn == 'jpeg' or fileVO.fileExtsn == 'PNG' or fileVO.fileExtsn == 'jpg')}">
                                    <li>
        ...
        <div class="bottom_btn">
            <a href="<c:url value='/'/>sub03/sub01_01.do">목록보기</a>
        </div>
...
<form name="downloadFrm" method="post" action="<c:url value="/cmm/fms/downloadEtcFile.do"></c:url>">
    <input type="hidden" name="bbsId" value="">
    <input type="hidden" name="fileIdx" value="0">
...
<script>
    function fn_egov_downFile_etc(bbsId, fileIdx, bbsIdx) {
        ...
        /*let f = document.downloadFrm

        if(bbsId == '' || fileIdx == '' || bbsIdx == '') return false

        f.bbsId.value = bbsId
        f.fileIdx.value = fileIdx
        f.bbsIdx.value = bbsIdx
