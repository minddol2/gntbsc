...
<form name="subForm" method="post" action="<c:url value='/sub03/sub01_01v_test.do'/>">
...
<script type="text/javascript">
    ...
    function fn_egov_inqire_BBS(nttId, bbsId) {
        ...
        document.submitParam.action = "<c:url value='/sub03/sub01_01v_test.do'/>";
        document.submitParam.submit();
    }

    function fn_egov_select_BBSList(pageNo) {
        document.frm.pageIndex.value = pageNo;
        document.frm.action = "<c:url value='/sub03/sub01_01_test.do'/>";
        document.frm.submit();
    }
