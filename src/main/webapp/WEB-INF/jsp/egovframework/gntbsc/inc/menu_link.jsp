...
String mLink[][][] = new String[12][11][10];
	...
	mTitle[2][0][0] = "운영프로그램"; mLink[2][0][0] = "sub02/sub01_01.do"; 
		...
		mTitle[2][3][0] = "운영사업"; mLink[2][3][0] = "sub02/sub03_01.do";
			mTitle[2][3][1] = "관광스타트업 발굴 및 육성"; mLink[2][3][1] = "sub02/sub03_01.do";
			mTitle[2][3][2] = "지역 기반 관광산업 개선"; mLink[2][3][2] = "sub02/sub03_02.do";
			mTitle[2][3][3] = "협력 네트워크 강화"; mLink[2][3][3] = "sub02/sub03_03.do";
			mTitle[2][3][4] = "관광인재육성 및 일자리 창출"; mLink[2][3][4] = "sub02/sub03_04.do";
			mTitle[2][3][5] = "지역센터 거버넌스 체계화"; mLink[2][3][5] = "sub02/sub03_05.do";
