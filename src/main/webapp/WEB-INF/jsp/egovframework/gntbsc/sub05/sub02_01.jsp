...
<form name="subForm" method="post" action="<c:url value='/sub05/sub02_view.do'/>">
	<input type="hidden" name="bbsTyCode" value="<c:out value='${brdMstrVO.bbsTyCode}'/>" />
	<input type="hidden" name="bbsAttrbCode" value="<c:out value='${brdMstrVO.bbsAttrbCode}'/>" />
	<input type="hidden" name="authFlag" value="<c:out value='${brdMstrVO.authFlag}'/>" />
	<input name="pageIndex" type="hidden" value="<c:out value='${searchVO.pageIndex}'/>"/>
...
<form name="frm" action="<c:url value='/sub05/sub02_01.do'/>" method="post">
...
<div class="boardType01 boardLink">
	<ul class="board_ul">
		<li class="title_li">
		...
		<c:forEach var="result" items="${resultList}" varStatus="status">
			<li class="noti_li">
				...
				<h5>				
					...
					<span class='title'><b class="tit"><c:out value="${result.nttSj}"/></b><i class="ic_blank"></i></span>
					</a>
					</c:if>
				</h5>
				<div class="boardInfo">
