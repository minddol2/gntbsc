...
<!--검색-->
<form name="subForm" method="post" action="<c:url value='/sub02/sub05_01v.do'/>">
...
<form name="frm" action="<c:url value='/sub02/sub05_01.do'/>" method="post">
...
function fn_egov_inqire_BBS(nttId, bbsId) {
	 ...
	 document.submitParam.action = "<c:url value='/sub02/sub05_01v.do'/>";
	 document.submitParam.submit();
}

function fn_egov_select_BBSList(pageNo) {
	document.frm.pageIndex.value = pageNo;
	document.frm.action = "<c:url value='/sub02/sub05_01.do'/>";
	document.frm.submit();
}
//-->
</script>
